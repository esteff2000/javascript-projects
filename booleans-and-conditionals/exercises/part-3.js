...
if (fuelLevel > 20000 && engineTemperature <= 25000) {
    ...
    } else if (fuelLevel < 1000 || engineTemperature > 35000 || engineIndicatorLight === 'red blinking') {
        console.log(" ENGINE FAILUER IMMINENT");
    } else {
...
if (fuelLevel > 2000 && (!engineIndicatorLight === 'red blinking' || !commandOverride === 'false')) {
